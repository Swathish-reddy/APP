...
export default function AnalyticsDashboard() {
  ...
  if (!data)
    return (
      <div className="flex flex-col items-center justify-center h-[80vh] text-center">
        ...
        <h2 className="text-2xl md:text-3xl font-extrabold text-foreground mb-2">System Disconnected</h2>
  ...
  return (
    <motion.div 
      className="dark p-4 md:p-8 max-w-[1600px] mx-auto space-y-8"
      variants={containerVariants}
      initial="hidden"
      animate="show"
    >
      {/* Header Section */}
      <motion.div variants={itemVariants} className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 bg-gradient-to-br from-slate-900 to-emerald-950 border border-emerald-500/20 p-4 md:p-8 rounded-3xl backdrop-blur-xl shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-4xl md:text-5xl font-black text-emerald-50 flex items-center gap-3 drop-shadow-md">
        ...
        <div className="relative z-10 flex items-center gap-4">
          <div className="flex flex-col items-end">
            ...
            <div className="flex items-center gap-3 bg-emerald-500/20 border border-emerald-400/30 px-6 py-3 rounded-2xl shadow-inner">
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {Object.entries(data["12_kpi_dashboard"] || {}).map(([key, value]: [string, any], index) => {
          ...
          return (
            <motion.div variants={itemVariants} key={key} className={`group relative bg-gradient-to-br ${gradients[index % 3]} border ${borderColors[index % 3]} p-5 md:p-6 rounded-3xl backdrop-blur-xl overflow-hidden transition-all duration-300 shadow-2xl`}>
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div>
                  <h3 className="text-slate-300 text-xs font-black uppercase tracking-widest mb-1 drop-shadow-sm">
                    {key.replace(/_/g, " ")}
                  </h3>
                  <div className="flex items-baseline gap-2 mt-2">
                    <p className={`font-black text-5xl md:text-6xl leading-tight ${colors[index % 3]} drop-shadow-lg`}>
                      {value}
                    </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <motion.div variants={itemVariants} className="lg:col-span-8 space-y-6">
          ...
          <div className="bg-gradient-to-br from-slate-900 to-emerald-950 border border-emerald-500/20 rounded-3xl p-5 md:p-8 backdrop-blur-xl relative overflow-hidden shadow-2xl">
            <div className="absolute bottom-0 right-0 w-64 h-64 bg-emerald-500/10 rounded-full blur-3xl pointer-events-none -mr-20 -mb-20"></div>
            
            <h3 className="text-2xl md:text-3xl font-black text-emerald-50 mb-6 flex items-center gap-3 drop-shadow-md relative z-10">
              <DollarSign className="text-emerald-400 w-8 h-8 drop-shadow-lg" /> Executive Financial Overview
            </h3>
            <div className="space-y-6 relative z-10">
              <p className="text-emerald-100 text-lg font-bold leading-relaxed drop-shadow-sm bg-black/20 p-5 rounded-2xl border border-emerald-500/10 shadow-inner">
                {data["1_executive_summary"]}
              </p>
              <div className="p-5 md:p-6 bg-emerald-500/15 border border-emerald-400/30 rounded-2xl shadow-inner">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div className="bg-white/5 p-6 rounded-2xl border border-white/10 shadow-inner hover:bg-white/10 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-b from-slate-900 to-indigo-950 border border-indigo-500/20 rounded-3xl p-5 md:p-6 shadow-2xl relative overflow-hidden">
              ...
              <p className="text-indigo-50 font-bold mb-4 text-base leading-relaxed relative z-10 bg-black/20 p-4 rounded-xl border border-white/5">{data["6_population_health_analytics"]}</p>
            ...
            <div className="bg-gradient-to-b from-slate-900 to-teal-950 border border-teal-500/20 rounded-3xl p-5 md:p-6 shadow-2xl relative overflow-hidden">
              ...
              <ul className="space-y-4 relative z-10 bg-black/20 p-4 rounded-xl border border-white/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-gradient-to-b from-slate-900 to-blue-950 border border-blue-500/20 rounded-3xl p-5 md:p-6 flex flex-col justify-center items-center text-center shadow-2xl hover:-translate-y-1 transition-transform">
            ...
            <div className="bg-gradient-to-b from-slate-900 to-purple-950 border border-purple-500/20 rounded-3xl p-5 md:p-6 flex flex-col justify-center items-center text-center shadow-2xl hover:-translate-y-1 transition-transform">
            ...
            <div className="bg-gradient-to-b from-slate-900 to-pink-950 border border-pink-500/20 rounded-3xl p-5 md:p-6 flex flex-col justify-center items-center text-center shadow-2xl hover:-translate-y-1 transition-transform">
        ...
        <motion.div variants={itemVariants} className="lg:col-span-4 space-y-6 flex flex-col h-full">
          ...
          <div className="bg-gradient-to-b from-slate-900 to-indigo-950 border border-indigo-500/20 rounded-3xl p-5 md:p-8 backdrop-blur-xl flex-grow flex flex-col shadow-2xl relative overflow-hidden">
            ...
            <div className="mt-8 pt-6 border-t border-indigo-500/20 relative z-10">
              ...
              <p className="text-sm text-indigo-100 font-bold italic leading-relaxed bg-black/20 p-4 rounded-xl border border-white/5">
          ...
          <div className="bg-gradient-to-b from-slate-900 to-cyan-950 border border-cyan-500/20 rounded-3xl p-5 md:p-6 shadow-2xl relative overflow-hidden">
            ...
            <p className="text-sm text-cyan-50 font-bold leading-relaxed relative z-10 bg-black/20 p-4 rounded-xl border border-white/5">
