    ...
    <div className="py-4 md:py-4 md:py-4 md:py-6 h-[calc(100vh-80px)] flex flex-col">
      ...
      <div className="flex justify-between items-end mb-6 flex-shrink-0">
        ...
        <button
          ...
          className="dark flex items-center gap-2 px-5 py-2.5 bg-muted hover:bg-slate-700 text-foreground font-semibold rounded-xl transition-all border border-border disabled:opacity-50"
        >
          {" "}
          <RefreshCw
