...
export default function DocumentCenter({
  ...
  return (
    <div className="flex h-[calc(100vh-120px)] gap-6 overflow-hidden p-2">
      ...
      <div className="w-full md:w-64 flex-shrink-0 flex flex-col gap-6 overflow-y-auto scrollbar-hide">
        ...
        <div className="bg-card border border-border/80 rounded-3xl p-5 shadow-2xl backdrop-blur-xl relative overflow-hidden group">
          ...
          <h3 className="text-[11px] font-bold text-muted-foreground uppercase tracking-widest mb-4 flex items-center">
            <Filter className="w-3.5 h-3.5 mr-2 text-blue-400" /> Document Types
          </h3>
      ...
      <div className="flex-1 flex flex-col gap-6 overflow-hidden">
        ...
        {isUploading && (
          <div className="bg-card border border-border/80 rounded-3xl p-4 md:p-6 shadow-2xl backdrop-blur-xl">
            <DocumentUpload
              patientId={patientId || ""}
              onUploadComplete={() => {
              ...
              >
                ...
                <div className="flex items-center justify-between mt-4 pt-4 border-t border-border/60">
                  ...
                  <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity translate-x-2 group-hover:translate-x-0 duration-200">
                    <button className="p-2 hover:bg-indigo-500/10 rounded-xl text-muted-foreground hover:text-indigo-400 transition-colors border border-transparent hover:border-indigo-500/20">
            ...
            {filteredDocs.length === 0 && !isUploading && (
              <div className="col-span-full py-16 flex flex-col items-center justify-center border-2 border-dashed border-border rounded-3xl bg-card/50 backdrop-blur-sm">
                ...
                <button
                  ...
                  className="px-4 md:px-6 py-3 bg-muted hover:bg-slate-700 border border-border hover:border-slate-600 text-foreground text-sm font-bold rounded-xl transition-all shadow-lg"
                >
