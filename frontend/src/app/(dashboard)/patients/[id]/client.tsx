...
export default function PatientOverview() {
  ...
  if (loading)
    return (
      <div className="text-muted-foreground p-4 md:p-8 text-center animate-pulse">
        Loading patient profile...
      </div>
    );
  if (!patient)
    return (
      <div className="text-muted-foreground p-4 md:p-8 text-center">
        Patient not found
      </div>
    );
  return (
    <div className="grid grid-cols-1 lg:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-1 space-y-6">
        ...
        <motion.div
          ...
          className="dark bg-card/50 border border-border rounded-3xl p-4 md:p-6 backdrop-blur-md shadow-lg"
        >
          {" "}
          <div className="flex justify-between items-start mb-6">
            {" "}
            <div className="w-20 h-20 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center text-foreground text-2xl md:text-3xl font-bold shadow-lg shadow-cyan-500/20">
              {" "}
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-2 md:grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4"
        >
          {" "}
          {[
        ...
        <motion.div
          ...
          className="grid md:grid-cols-1 md:grid-cols-2 gap-6"
        >
          {" "}
          {}{" "}
          <div className="dark bg-card/40 border border-border rounded-3xl p-4 md:p-6">
            {" "}
          ...
          {}{" "}
          <div className="dark bg-card/40 border border-border rounded-3xl p-4 md:p-6 md:col-span-2">
            {" "}
            <h3 className="text-lg font-semibold text-foreground flex items-center gap-2 mb-4">
              {" "}
