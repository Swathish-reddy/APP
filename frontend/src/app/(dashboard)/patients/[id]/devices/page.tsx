...
export default async function PatientDevices({ params }: { params: any }) {
  ...
  return (
    <div className="py-6 space-y-6 max-w-6xl mx-auto">
        ...
        <div className="flex gap-2">
          ...
          {["Apple Watch", "Garmin", "Fitbit"].map((brand) => (
            <button
              ...
              className="dark px-4 py-2 bg-slate-800 hover:bg-slate-700 text-slate-200 text-sm font-semibold rounded-xl transition-colors flex items-center gap-2"
            >
              {" "}
      ...
      {wearables.length === 0 ? (
        <div className="dark py-20 flex flex-col items-center justify-center border-2 border-dashed border-slate-800 rounded-3xl bg-slate-900/30">
          {" "}
        ...
        <div className="space-y-12">
          ...
          {wearables.map(({ device, data }) => {
            ...
            return (
              <div
                key={device.id}
                className="dark bg-slate-900/50 border border-slate-800 rounded-3xl p-6"
              >
                {" "}
                ...
                {data.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    {}{" "}
                    <div className="bg-slate-950/50 border border-slate-800/80 rounded-2xl p-5 flex items-center justify-between">
                      {" "}
                      <div className="flex items-center gap-4">
                        {" "}
