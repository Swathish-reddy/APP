...
export default function DocumentInsights({ document }: { document: any }) {
  if (!document) {
    return (
      <div className="bg-background/80 border border-border/80 rounded-3xl p-4 md:p-4 md:p-4 md:p-8 h-full flex flex-col items-center justify-center text-center shadow-2xl backdrop-blur-xl relative overflow-hidden">
        <div className="absolute top-0 right-0 p-4 md:p-4 md:p-4 md:p-8 opacity-5">
  ...
  return (
    <div className="bg-card border border-border/80 rounded-3xl p-4 md:p-4 md:p-4 md:p-6 h-full flex flex-col shadow-2xl backdrop-blur-xl relative overflow-hidden">
      {}
