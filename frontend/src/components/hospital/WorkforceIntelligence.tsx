...
export default function WorkforceIntelligence({ data }: { data: any }) {
  ...
  return (
    <div className="bg-card/60 border border-border/50 p-4 md:p-6 rounded-3xl backdrop-blur-xl shadow-xl h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div className="bg-muted/60 border border-border p-4 rounded-2xl flex items-center justify-between">
          <div><h4 className="text-muted-foreground text-xs font-bold uppercase mb-1">Burnout Alerts</h4><p className="text-2xl md:text-3xl font-black text-red-400">{wi.burnout_risk_count}</p></div>
