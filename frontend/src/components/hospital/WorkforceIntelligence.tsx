  ...
  return (
    <div className="bg-slate-900/60 border border-slate-700/50 p-6 rounded-3xl backdrop-blur-xl shadow-xl h-full">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-xl font-bold text-white">Workforce Intelligence</h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div className="bg-slate-800/60 border border-slate-700 p-4 rounded-2xl flex items-center justify-between">
          <div><h4 className="text-slate-400 text-xs font-bold uppercase mb-1">Burnout Alerts</h4><p className="text-3xl font-black text-red-400">{wi.burnout_risk_count}</p></div>
        ...
        <div className="bg-indigo-900/30 border border-indigo-500/30 p-4 rounded-2xl">
          ...
          <p className="text-white text-sm font-medium">{wi.ai_reassignment_recommendation}</p>
        </div>
      </div>
    </div>
  );
